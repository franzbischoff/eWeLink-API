...
登录接口成功后会返回 “access token”（登录成功后返回的at，即access token）。
...
- “Refresh Token” 有效期为两个月。“access token” 失效前，APP可通过 “刷新认证token” 接口重新获取新的 “access token” 和 “Refresh Token”，具体可查看[刷新认证token](/zh-cmn/接口中心_v2?id=刷新认证token)。
...
APP连接上设备热点后，执行第6步和第10步，设备正常回应后，APP断开设备热点，连上家庭路由器WiFi，请求"添加WiFi设备"接口，把设备添加到账号下。
